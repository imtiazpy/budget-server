...
SECRET_KEY = 'django-insecure-1t0h+ec7@%!j(c4q%-4el1#t@810@a+f#+)dpt6yqam@6)y-4&'
...
WSGI_APPLICATION = 'fmConfig.wsgi.application'


# Database
# https://docs.djangoproject.com/en/4.0/ref/settings/#databases

# Todo: Add postgresql database setting
DATABASES = {
    'default': {
